...
%   generation 2 from Ma et al. 2018, OUP Synbio parameters). Set to 0 to
%   not produce this design type. 
%
%
% SeriesB (default value = 1) 
%   Defines if the function will produce Series B designs (EAR2_H22 from 
%   Pardee et al. 2016). Set to 0 to not produce this design type. 
% 
...
function toehold_switch_design_run(num_designs,input_file,options)
    ...
    RUN_TSGEN2 = options.SeriesA; 
    RUN_EAR2_H22 = options.SeriesB; 
	...
	%Generate Series A designs (Toehold Switch generation 2, Ma et al. 2018)
	if RUN_TSGEN2
		sensor_TSgen2_stage1_1; %generate sequences and performance parameters
		sensor_TSgen2_stage2_scoring_1; %score each design
		sensor_TSgen2_stage3_selection_1; %Select FINAL_NUM_DESIGNS for testing
	end

	%Generate Series B style designs (EAR2_H22, Pardee et al. 2016)
	if RUN_EAR2_H22
		sensor_EAR2_H22_gen_stage1_1; %generate sequences and performance parameters
		sensor_EAR2_H22_gen_stage2_scoring_1; %score each design
		sensor_EAR2_H22_gen_stage3_selection_1; %Select FINAL_NUM_DESIGNS for testing
	end
